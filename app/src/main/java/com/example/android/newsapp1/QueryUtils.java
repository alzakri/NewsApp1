...
import com.example.android.newsapp1.NewsApp;
...
public final class QueryUtils {
    ...
    public static List<NewsApp> fetchEarthquakeData(String requestUrl) {
        ...
        List<NewsApp> earthquakes = extractFeatureFromJson(jsonResponse);
    ...
    private static List<NewsApp> extractFeatureFromJson(String earthquakeJSON) {
        ...
        List<NewsApp> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                NewsApp earthquake = new NewsApp(magnitude, location, time, url);
