    ...
    private static List<NewsApp> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Extract the value for the key called "mag"webTitle
                ...
                String author = currentEarthquake.getString("sectionId");

                // Extract the value for the key called "url"
                String url = currentEarthquake.getString("webUrl");

                // Create a new {@link Earthquake} object with the title, date, author,
                // and url from the JSON response.
                NewsApp newsApp = new NewsApp(title, date, author, url);

                // Add the new {@link Earthquake} to the list of newsApps.
